...
import checkFields from './src/actionEventsLogic/addClassOnChange.js';
...
const startApp = () => {
    ...
    edit.init(page, viewsRenderHandler, authService,subjectService,checkFields);
    ...
    createPage.init(page, viewsRenderHandler, subjectService,checkFields);

...
export const isValidCategory = (param) => {
    if(!(['Java','CSharp','JavaScript','Python'].includes(param))){
        exceptionMethods.throwNewGeneralError(constants.CATEGORY_SHOULD_BE_CORRECT);
    }
};

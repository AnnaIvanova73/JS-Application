...
const navTemplate = (viewModel) => {
    return html`
        ...
        <a href="/allRecords" class=${ifDefined(viewModel.currPage.startsWith('/allRecords') ? 'active' : undefined)}>All Listings</a>
        ...
        ${viewModel.isLoggedIn
                ...
                html`
                    <div id="profile">
                        ...
                        <a href=/userRecords class=${ifDefined(viewModel.currPage.startsWith('/userRecords') ? 'active' : undefined)} >My Listings</a>
                        <a href="/create" class=${ifDefined(viewModel.currPage.startsWith('/create') ? 'active' : undefined)}>Create Listing</a>

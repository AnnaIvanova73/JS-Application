...
const retrieveLoggedUserData = async () => {
    await httpRequester.get(`${constants.BASE_URL}${constants.endPoints.currUserPoint}`, true);
    removeUserInfo();
};
export default {
    isLoggedIn, getToken, getEmail, getUserId, logUser, regUser, logout, removeToken:removeUserInfo,getUsername,retrieveLoggedUserData
};